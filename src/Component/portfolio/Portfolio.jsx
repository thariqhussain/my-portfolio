...
export default function Portfolio() {
  ...
  const scrollToSection = (id) => {
    ...
    if (element) {
      let offset = isMobile ? 60 : 80;
      if (id === 'projects') {
        offset = isMobile ? 60 : 30;
      }
  ...
  return (
    <div className="portfolio-container">
      ...
      <section id="stack">
        <div className="section-container">
          <div id="stack" className="tech-stack-section">
            {/* Frontend */}
            <div className='tech-section-seperation'>
              <h2>Frontend</h2>
              <div className='tech-skills'>
                <ul>
                  <li className='img-and-skill'>
            ...
            <div className='tech-section-seperation'>
              ...
              <div className='tech-skills'>
                <ul>
                  ...
                  <li className='img-and-skill'>
                    <img src={antiGravityIcon} alt='Anti Gravity' />
                    <span>Anti Gravity</span>
                  </li>
                  <li className='img-and-skill'>
                    <img src={claudeAIIcon} alt='Claude AI' />
                    <span>Claude AI</span>
                  </li>
                  <li className='img-and-skill'>
                  ...
                  <li className='img-and-skill'>
                    <img src={geminiIcon} alt='Gemini AI' />
                    <span>Gemini AI</span>
                  </li>
                </ul>
              </div>
      ...
      <section id="contact" className="contact-section">
        <div className="section-container contact-center">
          ...
          <div className="social-links">
            <MenuItem 
              label="GitHub" 
              href="https://github.com/thariqhussain" 
            ...
            <MenuItem 
              label="LinkedIn" 
              href="https://www.linkedin.com/in/thariq-hussain5/" 
          ...
          <div className="contact-box">
            <p className="contact-email">
              <span>thariqhussain5@gmail.com</span>
            </p>
      ...
      <footer className="footer">
        <p>© 2025 Thariq Hussain. Built with React.</p>
      </footer>
    </div>
  );
}